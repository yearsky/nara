...
function SymphonyQuizContent() {
  ...
  useEffect(() => {
    const quizData = getSymphonyQuizById(quizId);
    ...
    if (quizData) {
      ...
      router.push("/learn/symphony");
    }
  }, [quizId, router]);

  if (!quiz) {
    return (
      <div className="min-h-screen bg-gradient-to-b from-pink_50/30 to-rose_50/30 flex items-center justify-center">
        <div className="animate-spin rounded-full h-12 w-12 border-b-2 border-pink_600"></div>
      </div>
    );
  }
  ...
  const handleNextActivity = () => {
    router.push(`/learn/symphony/games?id=${quizId}`);
  };
  ...
  if (showResults) {
    return (
      <div className="min-h-screen bg-gradient-to-b from-pink_50/30 to-rose_50/30 pb-8 pt-6">
        <SubmoduleHeader
          title="Hasil Quiz"
          subtitle={quiz.title}
          icon={Award}
        ...
        <main className="max-w-2xl mx-auto px-4 py-6">
          ...
          >
            <div className="bg-white/90 backdrop-blur-sm rounded-3xl p-8 shadow-2xl border border-white/50 text-center">
              ...
              >
                <div className="w-32 h-32 rounded-full bg-gradient-to-br from-pink_500 to-rose_600 flex items-center justify-center mx-auto mb-4 shadow-xl">
              ...
              >
                <div className="text-5xl font-bold text-pink_900 mb-2">
                  {finalScore}
                </div>
            ...
            <div className="space-y-3">
              {passed ? (
                <motion.button
                  ...
                  className="w-full bg-gradient-to-r from-pink_500 to-rose_600 text-white font-bold py-4 px-6 rounded-2xl shadow-lg flex items-center justify-center gap-2"
                >
              ...
              <motion.button
                ...
                className="w-full bg-gradient-to-r from-pink_600 to-rose_600 text-white font-bold py-4 px-6 rounded-2xl shadow-lg flex items-center justify-center gap-2"
              >
      ...
      <main className="max-w-2xl mx-auto px-4 py-6">
        <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-4 mb-6 shadow-lg border border-white/50">
          <div className="flex items-center justify-between mb-2">
            ...
            <span className="text-sm font-medium text-pink_600">
              {Math.round(progress)}%
            </span>
          </div>
          <div className="w-full bg-gray-200 rounded-full h-2 overflow-hidden">
            <motion.div
              className="h-full bg-gradient-to-r from-pink_600 to-rose_600 rounded-full"
              initial={{ width: 0 }}
          ...
          >
            <div className="bg-white/90 backdrop-blur-sm rounded-3xl p-6 shadow-xl border border-white/50">
              <div className="flex items-start gap-3 mb-4">
                <div className="w-10 h-10 rounded-full bg-gradient-to-br from-pink_500 to-rose_600 flex items-center justify-center flex-shrink-0 text-white font-bold">
