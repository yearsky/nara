...
import { getStoryById } from "@/lib/storiesData";
import {
  getQuizByStoryId,
  calculateScore,
  getGradeFromScore,
...
export default function QuizPage() {
  ...
  useEffect(() => {
    ...
    const quizData = getQuizByStoryId(storyId);
    ...
    if (storyData && quizData) {
      ...
      router.push(`/learn/verse/${storyId}`);
    }
  }, [storyId, router]);
  ...
  const handleNextActivity = () => {
    router.push(`/learn/verse/${storyId}/games`);
  };
        ...
        <main className="max-w-2xl mx-auto px-4 py-6">
          ...
          >
            ...
            <div className="bg-white/90 backdrop-blur-sm rounded-3xl p-8 shadow-2xl border border-white/50 text-center">
              ...
              >
                <div className="w-32 h-32 rounded-full bg-gradient-to-br from-purple-500 to-pink-500 flex items-center justify-center mx-auto mb-4 shadow-xl">
    ...
    <div className="min-h-screen bg-gradient-to-b from-purple-50/30 to-pink-50/30 pb-32 pt-6">
      ...
      <NaraAssistant
        ...
        hints={[
          ...
          "Ingat-ingat kembali cerita yang sudah kamu baca! 💭",
          "Jangan terburu-buru, pikirkan baik-baik sebelum menjawab! 🤔",
        ]}
        autoGreet={true}
      />
